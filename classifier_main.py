...
def _parse_args():
    ...
    parser.add_argument('--train_path', type=str, default='/root/NLP-Person-Name-Detection-master/data/eng.train', help='path to train set (you should not need to modify)')
    parser.add_argument('--dev_path', type=str, default='/root/NLP-Person-Name-Detection-master/data/eng.testa', help='path to dev set (you should not need to modify)')
    parser.add_argument('--blind_test_path', type=str, default='/root/NLP-Person-Name-Detection-master/data/eng.testb.blind', help='path to dev set (you should not need to modify)')
...
def predict_write_output_to_file(exs, classifier, outfile):
    ...
    for ex in exs:
        ...
        f.write("\n")
    f.close()
#dev_class_exs , train_class_exas are our training data and our test dataset based on person examples
